...
namespace DojoSecret.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpGet]
        [Route("Interests")]
        public IActionResult Hovers()
        {
            System.Console.WriteLine("**********Hitting the Interests route**********");
        ...
        {
            System.Console.WriteLine("**********Hitting the Clicks route**********");
            return View("NinjaToCat");
        }
        [HttpGet]
        [Route("ClientEvents")]
        public IActionResult Events()
        {
            System.Console.WriteLine("**********Hitting the Events route**********");
        ...
        {
            System.Console.WriteLine("**********Hitting the WeatherAPI route**********");
            return View("Weather");
        }
